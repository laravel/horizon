<template>
    <tr>
        <td class="horizon-linked-cell">
            <router-link class="horizon-row-link horizon-cell-link" :title="job.name" :to="{ name: 'job-preview', params: { jobId: job.id, type: $route.params.type }}">
                {{ jobBaseName(job.name) }}

                <small class="horizon-row-action ms-1 badge badge-warning badge-sm rounded-pill"

...
<template>
    <div>
        <div class="card overflow-hidden">
            ...
            >
                <h2 class="h6 m-0" v-if="$route.params.type == 'pending'">
                    Pending Jobs
                </h2>
                <h2 class="h6 m-0" v-if="$route.params.type == 'completed'">
                    Completed Jobs
                </h2>
                <h2 class="h6 m-0" v-if="$route.params.type == 'silenced'">
                    Silenced Jobs
                </h2>
            </div>
            ...
            >
                ...
                <tbody>
                    ...
                    >
                        <td
                            colspan="100"
                            class="text-center card-bg-secondary py-1"
                        >
                            <small
                                ><a
                                    href="#"

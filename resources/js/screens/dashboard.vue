                            ...
                            <div class="d-flex align-items-center mt-2">
                                ...
                                <small
                                    v-if="
                                        ...
                                        stats.pausedMasters > 0
                                    "
                                    class="mb-0 ms-2"
                                    >({{ stats.pausedMasters }} paused)</small
                                >
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="w-25">
                        <div class="p-4 mb-0">
                            ...
                            <p class="mt-2 mb-0">
                                {{
                                    stats.max_wait_time
                                        ? humanTime(stats.max_wait_time)
                                        : "-"
                                }}
                            </p>

                            <small class="mt-1" v-if="stats.max_wait_queue"
                                >({{ stats.max_wait_queue }})</small
                            >
                        </div>
                    </div>
                ...
                <tbody>
                    <tr v-for="supervisor in worker.supervisors">
                        <td>
                            ...
                            <svg
                                v-if="supervisor.status == 'inactive'"
                                class="fill-danger me-1"
                                viewBox="0 0 20 20"
                                style="width: 1rem; height: 1rem"
                            >
                                <path
                        ...
                        <td
                            class="text-end text-muted"
                            v-if="supervisor.options.balance"
                        >
                            {{
                                supervisor.options.balance
                                    .charAt(0)
                                    .toUpperCase() +
                                supervisor.options.balance.slice(1)
                            }}
                        </td>
                        <td class="text-end text-muted" v-else>Disabled</td>
                    </tr>
                </tbody>
            </table>
        </div>

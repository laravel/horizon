<script type="text/ecmascript-6">
    ...
    export default {
        ...
        methods: {
            ...
            /**
             * Displays confirmation to purges queued jobs from given queue
             */
            confirmPurgeQueue(queue) {
                this.purge.queue = queue.name;
                this.purge.message = `Are you sure you want to purge '${queue.name}' queue?`;
            ...
            /**
             * Purges queued jobs from given queue
             */
            purgeQueue() {
                this.$http.post(`/${Horizon.path}/api/purge`, { queue: this.purge.queue }).then(response => {
...
<template>
    <div>
        ...
        <div class="card mt-4" v-if="workload.length">
            ...
            <table class="table table-hover table-sm mb-0">
                ...
                <tr v-for="queue in workload">
                    ...
                    <td>
                        <button class="btn btn-outline-danger" title="Clear queued jobs" :disabled="purge.queue === queue.name" @click="confirmPurgeQueue(queue)">
        ...
        <alert ref="purgeModal" :message="purge.message" type="confirmation" v-if="purge.confirm" :confirmation-proceed="purgeQueue"></alert>
    </div>
</template>

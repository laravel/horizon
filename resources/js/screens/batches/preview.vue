        ...
        <div class="card overflow-hidden">
            ...
            >
                ...
                <button
                    ...
                    v-on:click.prevent="retry(batch.id)"
                >
                    <svg
            ...
            <div class="card-body card-bg-secondary" v-if="ready">
                <div class="row mb-2">
                    ...
                    <div class="col">
                        ...
                        <small
                            class="ms-1 badge badge-danger badge-sm"
                            v-if="
                                batch.failedJobs > 0 &&
                        ...
                        <small
                            class="ms-1 badge badge-success badge-sm"
                            v-if="
                                batch.totalJobs - batch.pendingJobs ==
                                batch.totalJobs
                            "
                        ...
                        <small
                            class="ms-1 badge badge-secondary badge-sm"
                            v-if="batch.pendingJobs > 0 && !batch.failedJobs"
                        >
                            Pending
                        </small>
                    </div>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col">
                        {{
                            formatDateIso(batch.createdAt).format(
                                "YYYY-MM-DD HH:mm:ss"
                            )
                        }}
                    </div>
                ...
                <div class="row mb-2" v-if="batch.finishedAt">
                    ...
                    <div class="col">
                        {{
                            formatDateIso(batch.finishedAt).format(
                                "YYYY-MM-DD HH:mm:ss"
                            )
                        }}
                    </div>
                ...
                <div class="row mb-2" v-if="batch.cancelledAt">
                    ...
                    <div class="col">
                        {{
                            formatDateIso(batch.cancelledAt).format(
                                "YYYY-MM-DD HH:mm:ss"
                            )
                        }}
                    </div>
                ...
                <div class="row">
                    <div class="col-md-2 text-muted">
                        Processed Jobs<br /><small>(Including Failed)</small>
                    </div>
                    <div class="col">
                        {{ batch.processedJobs }} ({{ batch.progress }}%)
                    </div>
                </div>
            </div>
        </div>

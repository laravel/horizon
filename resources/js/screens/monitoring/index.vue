        ...
        monitorNewTag() {
            ...
            this.$http.post(Horizon.basePath + '/api/monitoring', {'tag': this.newTag})
                .then(response => {
                    ...
                    this.tags.push({tag: this.newTag, count: 0, succeeded_count: 0, failed_count: 0});
                    this.newTag = '';
                })
        },
    ...
    <div>
        ...
        <div class="card overflow-hidden">
            ...
            >
                ...
                <button @click="openNewTagModal" class="btn btn-primary btn-sm">
                    Monitor Tag
                </button>
            </div>

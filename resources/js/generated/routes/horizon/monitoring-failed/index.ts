...
* @see src/Http/Controllers/MonitoringPageController.php:42
* @route '/horizon/monitoring/{tag}/failed'
*/
...
page.definition = {
    methods: ["get","head"],
    url: '/horizon/monitoring/{tag}/failed',
...
export default monitoringFailed
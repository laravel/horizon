...
const downForMaintenance = computed(() => window.Horizon.config('downForMaintenance'))
</script>
  ...
  <div v-cloak id="horizon">
    ...
    <div class="container mb-5">
      <div class="d-flex align-items-center py-4 header">
          <Link :href="$url('/')" class="logo d-flex align-items-center">
          ...
          <div class="ms-auto">
              ...
              <button class="btn btn-muted ms-2" :class="{active: autoLoadsNewEntries}" title="Auto Load New Entries" @click.prevent="autoLoadNewEntries">
      ...
      <div class="row mt-4">
        <div class="col-2 sidebar">
          <ul class="nav flex-column">
            <li class="nav-item">
              <Link :href="$url('/dashboard')" class="nav-link d-flex align-items-center">
            ...
            <li class="nav-item">
              <Link :href="$url('/monitoring')" class="nav-link d-flex align-items-center">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
            ...
            <li class="nav-item">
              <Link :href="$url('/metrics')" class="nav-link d-flex align-items-center">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
            ...
            <li class="nav-item">
              <Link :href="$url('/jobs/pending')" class="nav-link d-flex align-items-center">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
            ...
            <li class="nav-item">
              <Link :href="$url('/jobs/completed')" class="nav-link d-flex align-items-center">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
            ...
            <li class="nav-item">
                <Link :href="$url('/jobs/silenced')" class="nav-link d-flex align-items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
            ...
            <li class="nav-item">
                <Link :href="$url('/failed')" class="nav-link d-flex align-items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
        ...
        <div class="col-10">
          <div v-if="downForMaintenance" class="alert alert-warning">

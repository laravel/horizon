<script type="text/ecmascript-6">
    ...
    export default {
        ...
        computed: {
            schemeTitle () {
                return {
                    system: 'Color scheme: system. Switch to dark.',
                    dark: 'Color scheme: dark. Switch to light.',
                    light: 'Color scheme: light. Switch to system.',
                }[this.scheme]
            }
        },
        ...
        methods: {
            ...
            calculateScheme () {
                ...
                window.dispatchEvent(new Event('horizon-color-scheme-changed'));
            }
        }
    }
</script>

...
<div id="horizon" v-cloak>
    <poll v-on:poll="loadStats" :interval="5"></poll>
    ...
    <div class="horizon-shell">
        <aside class="horizon-sidebar">
            <header class="horizon-sidebar-header">
                <router-link to="/" class="logo d-flex align-items-center">
                    ...
                    <div class="horizon-logo-copy ms-2">
                        <h1 class="mb-0">
                            <strong>Laravel</strong> Horizon
                        </h1>

                        @if (config('horizon.name'))
                            <span class="horizon-logo-subtitle" title="{{ config('horizon.name') }}">
                                {{ config('horizon.name') }}
                            </span>
                        @endif
                    </div>
            ...
            <nav class="horizon-sidebar-content" aria-label="Horizon navigation">
                <p class="horizon-sidebar-label">Pages</p>
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <router-link active-class="active" to="/monitoring" class="nav-link d-flex align-items-center">
                            ...
                            <span v-if="navigationCount('monitoring') !== null" class="horizon-nav-count ms-auto">
                                @{{ navigationCount('monitoring') }}
                            </span>
                        </router-link>
                    </li>
                    <li class="nav-item">
                        <router-link active-class="active" to="/metrics" class="nav-link d-flex align-items-center">
                            ...
                            <span>Metrics</span>
                            <span v-if="navigationCount('metrics') !== null" class="horizon-nav-count ms-auto">
                                @{{ navigationCount('metrics') }}
                            </span>
                        </router-link>
                    </li>
                    <li class="nav-item">
                        <router-link active-class="active" to="/batches" class="nav-link d-flex align-items-center">
                            ...
                            <span>Batches</span>
                            <span v-if="navigationCount('batches') !== null" class="horizon-nav-count ms-auto">
                                @{{ navigationCount('batches') }}
                            </span>
                        </router-link>
                    </li>
                    <li class="nav-item">
                        <router-link active-class="active" to="/jobs/pending" class="nav-link d-flex align-items-center">
                            ...
                            <span v-if="navigationCount('pending') !== null" class="horizon-nav-count ms-auto">
                                @{{ navigationCount('pending') }}
                            </span>
                        </router-link>
                    </li>
                    <li class="nav-item">
                        <router-link active-class="active" to="/jobs/completed" class="nav-link d-flex align-items-center">
                            ...
                            <span v-if="navigationCount('completed') !== null" class="horizon-nav-count ms-auto">
                                @{{ navigationCount('completed') }}
                            </span>
                        </router-link>
                    </li>
                    <li class="nav-item">
                        <router-link active-class="active" to="/jobs/silenced" class="nav-link d-flex align-items-center">
                            ...
                            <span v-if="navigationCount('silenced') !== null" class="horizon-nav-count ms-auto">
                                @{{ navigationCount('silenced') }}
                            </span>
                        </router-link>
                    </li>
                    <li class="nav-item">
                        <router-link active-class="active" to="/failed" class="nav-link d-flex align-items-center">
                            ...
                            <span v-if="navigationCount('failed') !== null" class="horizon-nav-count ms-auto">
                                @{{ navigationCount('failed') }}
                            </span>
                        </router-link>
                    </li>
                </ul>
            ...
            <footer class="horizon-sidebar-footer">
                <p class="horizon-sidebar-label">Settings</p>

                <scheme-toggler></scheme-toggler>

                <button
                    class="btn horizon-setting"
                    :class="{active: autoLoadsNewEntries}"
                    :aria-pressed="autoLoadsNewEntries"
                    v-on:click.prevent="autoLoadNewEntries"
                    title="Auto Load New Entries"
                >
                    <span class="horizon-setting-label">
                    ...
                    <span class="horizon-switch" aria-hidden="true">
                        <span></span>
                    </span>
                </button>
            </footer>
